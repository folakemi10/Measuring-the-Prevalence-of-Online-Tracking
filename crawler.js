...
function openBrowser(log, proxyHost, executablePath) {
    ...
    const ext = '/Users/18707/Downloads/uBlock0.chromium'
    // const ext = '/Users/umariqbal/Documents/-miniproject/uBlock0-4.chromium'

    args.headless = false;
    args.args.push(`--disable-extensions-except=${ext}`);
    args.args.push(`--load-extension=${ext}`);
